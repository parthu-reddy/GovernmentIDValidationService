...
@AutoConfigureStubRunner(ids = "com.fooddelivery:restaurant-application:+:stubs", stubsMode = StubRunnerProperties.StubsMode.REMOTE, repositoryRoot = "git://file:///tmp/FoodDelivery/FoodDeliveryContracts/.git")
