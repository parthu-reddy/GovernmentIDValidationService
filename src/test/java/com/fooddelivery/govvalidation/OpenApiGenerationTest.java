...
public class OpenApiGenerationTest {
    ...
    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.governmentid.service.ExecutiveDocumentService executiveDocumentService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.governmentid.service.BiometricVerificationService biometricVerificationService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.governmentid.service.FinancialVerificationService financialVerificationService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.governmentid.service.VehicleVerificationService vehicleVerificationService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.governmentid.service.DrivingLicenseVerificationService drivingLicenseVerificationService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.governmentid.service.BrandVerificationService brandVerificationService;

    @org.springframework.boot.autoconfigure.SpringBootApplication(scanBasePackages = {"com.fooddelivery.governmentid.controller"}, excludeName = {"org.springframework.boot.autoconfigure.security.servlet.SecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.servlet.ManagementWebSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.reactive.ReactiveSecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.reactive.ManagementReactiveSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.oauth2.resource.servlet.OAuth2ResourceServerAutoConfiguration"})
