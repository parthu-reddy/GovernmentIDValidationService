...
public class BrandVerificationService {
    ...
    public void verifyGstin(UUID brandId, String gstin, String brandName) {
        ...
        BrandDocument doc = documentRepository.findByBrandIdAndDocType(brandId, DocumentType.GSTIN)
                .orElseGet(() -> BrandDocument.builder().id(UUID.randomUUID()).brandId(brandId).docType(DocumentType.GSTIN).build());
        ...
        // Audit log
        BrandVerificationAuditLog audit = BrandVerificationAuditLog.builder()
                .id(UUID.randomUUID())
                .entityType("BRAND")
                .entityId(brandId)
                .verificationProvider("KARZA_GSTIN")
                .rawRequestPayload("{\"gstin\":\"" + gstin + "\"}")
                .rawResponsePayload(doc.getApiRawResponse())
                .status(status.name())
    ...
    public void initiatePennyDrop(UUID brandId, String accountNumber, String ifsc, String brandName) {
        ...
        BrandBankDetails bankDetails = bankDetailsRepository.findByBrandId(brandId)
                .orElseGet(() -> BrandBankDetails.builder().id(UUID.randomUUID()).brandId(brandId).build());
    ...
    public void processPennyDropWebhook(UUID brandId, String beneficiaryName, boolean isSuccess, String registeredBrandName) {
        ...
        try {
            ...
            BrandVerificationAuditLog audit = BrandVerificationAuditLog.builder()
                    ...
                    .entityType("BRAND")
                    .entityId(brandId)
                    .verificationProvider("PENNY_DROP_WEBHOOK")
                    .rawRequestPayload("{\"webhook_received\":true}")
                    .rawResponsePayload("{\"beneficiaryName\":\"" + beneficiaryName + "\"}")
