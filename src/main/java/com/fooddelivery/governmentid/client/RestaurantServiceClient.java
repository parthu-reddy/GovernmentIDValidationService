...
@FeignClient(name = "restaurant-application", url = "${restaurant.base.url:}", fallback = RestaurantServiceClientFallback.class)
public interface RestaurantServiceClient {
    ...
    class VerificationCallbackRequest {
        ...
        public boolean equals(final java.lang.Object o) {
            ...
            if (!(o instanceof RestaurantServiceClient.VerificationCallbackRequest)) return false;
            final RestaurantServiceClient.VerificationCallbackRequest other = (RestaurantServiceClient.VerificationCallbackRequest) o;
        ...
        protected boolean canEqual(final java.lang.Object other) {
            return other instanceof RestaurantServiceClient.VerificationCallbackRequest;
        }
        ...
        public java.lang.String toString() {
            return "RestaurantServiceClient.VerificationCallbackRequest(verificationType=" + this.getVerificationType() + ", status=" + this.getStatus() + ", legalEntityName=" + this.getLegalEntityName() + ", bankBeneficiaryName=" + this.getBankBeneficiaryName() + ", matchScore=" + this.getMatchScore() + ")";
        }
    }
}
